...
struct ProfileView: View {
  ...
  private var aboutSection: some View {
    Section(
      ...
      linkRow(
        "Source Code", systemImage: "chevron.left.forwardslash.chevron.right",
        url: "https://github.com/je09/kinopub-mac-client")
      linkRow(
        "Report a Problem", systemImage: "exclamationmark.bubble",
        url: "https://github.com/je09/kinopub-mac-client/issues/new")
      linkRow(
        "Install Guide & FAQ", systemImage: "book",
        url: "https://github.com/je09/kinopub-mac-client/wiki")
    }
  }
